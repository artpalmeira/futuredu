...
<body id="cursos">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xxl-7 col-xl-6">
                        <div class="banner-thumb">
                            <img src="assets/img/banner/01.png" alt="FuturEdu - Educação para o Futuro">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Início da seção de Cursos -->
    <div class="categorias">
        <div class="site">
            <div class="categoria-text-top">
                <h2 class="title">Curso de Desenvolvimento</h2>
            </div>
            <div class="lista">
                <div>
                    ...
                    <?php foreach ($cursos as $linha): ?>
                        ...
                        <div class="listaCurso">
                            <div class="lista-categoria">
                                <img src="<?= URL_BASE ?>upload/curso/<?= $linha['foto_curso'] ?>" alt="<?= $linha['nome_curso'] ?>" />
                                <div class="conteudo-categoria">
                                    <a href="curso/detalhe/<?= $link ?>">
                                        <h6><?= $linha['nome_curso'] ?></h6>
                                    </a>
                                    <span><?= $linha['carga_horaria_curso'] . ' horas | R$ ' . $linha['valor_curso']; ?> </span>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
