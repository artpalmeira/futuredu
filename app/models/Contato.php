...
class Contato extends Model{
    ...
    public function salvarEmail($nome, $email, $fone, $assunto, $msg, $status, $dataHora){
        ...
        $sql = "INSERT INTO tbl_contato(nome_contato, email_contato, telefone_contato, assunto_contato, mensagem_contato, status_contato, data_hora_contato) VALUES (:nome, :email, :fone, :assunto, :msg, :status_contato, :data_hora)";
